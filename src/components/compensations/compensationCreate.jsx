...
export default function CreateCompensation({nav, header, postRequest, fetchEmployees }) {
    ...
    const handleCompensationSubmit = async (e) => {
        e.preventDefault();
        const compensationPostJson = await postRequest("https://hris-qp6t.onrender.com/compansation/create", compensationForm);
